...
SUSHI is configured by a single **sushi-config.yaml** file. This file is written using [YAML](https://yaml.org/). Authors unfamiliar with [YAML](https://learnxinyminutes.com/docs-beta/yaml/) should note that:
...
SUSHI can generate a simple configuration file for you with the `--init` [option](/docs-beta/sushi/project/#initializing-a-sushi-project)
{{% /alert %}}
