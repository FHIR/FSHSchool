...
This documentation is for SUSHI 1.0.0, and this version contains significant changes to the project structure. For documentation on project structure in older versions of SUSHI, see the [legacy documentation](/docs/sushi/project-legacy).
{{% /alert %}}
...
This project structure integrates with the HL7 IG Publisher [Auto-Builder](https://github.com/FHIR/auto-ig-builder/blob/master/README.md). When the IG Publisher detects an **input/fsh** subdirectory, it will automatically run SUSHI on that directory and output the SUSHI results to an **input/fsh-generated** subdirectory (e.g., **simple-ig/input/fsh-generated** in the example above). It will then continue with the normal IG Publisher process.
